...
class AddForeignKeysToOrderInvitationsTable extends Migration {
	...
	public function up()
	{
		Schema::table('order_invitations', function(Blueprint $table)
		{
			...
			$table->foreign('client_contact_id', 'order_invitations_ibfk_2')->references('id')->on('client_contacts')->onUpdate('NO ACTION')->onDelete('CASCADE');
	...
	public function down()
	{
		Schema::table('order_invitations', function(Blueprint $table)
		{
			...
			$table->dropForeign('order_invitations_ibfk_2');
