...
class AccountSettings extends BaseSettings
{
        private $settings = [
            ...
            'email_subject_custom1'              => ['required' => false, 'default_value' => trans('texts.custom1_subject'), 'type' => 'string'],
            'email_subject_custom2'              => ['required' => false, 'default_value' => trans('texts.custom2_subject'), 'type' => 'string'],
            'email_subject_custom3'              => ['required' => false, 'default_value' => trans('texts.custom3_subject'), 'type' => 'string'],
            'email_template_custom1'             => ['required' => false, 'default_value' => trans('texts.custom1_body'), 'type' => 'string'],
            'email_template_custom2'             => ['required' => false, 'default_value' => trans('texts.custom2_body'), 'type' => 'string'],
            'email_template_custom3'             => ['required' => false, 'default_value' => trans('texts.custom3_body'), 'type' => 'string'],
            ...
            'email_subject_invoice'              => ['required' => false, 'default_value' => trans('texts.invoice_subject'), 'type' => 'string'],
            'email_subject_quote'                => ['required' => false, 'default_value' => trans('texts.quote_subject'), 'type' => 'string'],
            'email_subject_credit'               => ['required' => false, 'default_value' => trans('texts.credit_subject'), 'type' => 'string'],
            'email_subject_payment'              => ['required' => false, 'default_value' => trans('texts.payment_subject'), 'type' => 'string'],
            'email_subject_lead'                 => ['required' => false, 'default_value' => trans('texts.lead_subject'), 'type' => 'string'],
            'email_subject_order'                => ['required' => false, 'default_value' => trans('texts.order_subject'), 'type' => 'string'],
            'email_subject_payment_partial'      => ['required' => false, 'default_value' => trans('texts.partial_payment_subject'), 'type' => 'string'],
            'email_template_invoice'             => ['required' => false, 'default_value' => trans('texts.invoice_body'), 'type' => 'string'],
            'email_template_quote'               => ['required' => false, 'default_value' => trans('texts.quote_body'), 'type' => 'string'],
            'email_template_credit'              => ['required' => false, 'default_value' => trans('texts.credit_body'), 'type' => 'string'],
            'email_template_payment'             => ['required' => false, 'default_value' => trans('texts.payment_body'), 'type' => 'string'],
            'email_template_lead'                => ['required' => false, 'default_value' => trans('texts.lead_body'), 'type' => 'string'],
            'email_template_order'               => ['required' => false, 'default_value' => trans('texts.order_body'), 'type' => 'string'],
            'email_template_payment_partial'     => ['required' => false, 'default_value' => trans('texts.partial_payment_body'), 'type' => 'string'],
            'email_subject_reminder1'            => ['required' => false, 'default_value' => trans('texts.reminder1_subject'), 'type' => 'string'],
            'email_subject_reminder2'            => ['required' => false, 'default_value' => trans('texts.reminder2_subject'), 'type' => 'string'],
            'email_subject_reminder3'            => ['required' => false, 'default_value' => trans('texts.reminder3_subject'), 'type' => 'string'],
            'email_subject_reminder_endless'     => ['required' => false, 'default_value' => trans('texts.endless_subject'), 'type' => 'string'],
            'email_template_reminder1'           => ['required' => false, 'default_value' => trans('texts.reminder1_body'), 'type' => 'string'],
            'email_template_reminder2'           => ['required' => false, 'default_value' => trans('texts.reminder2_body'), 'type' => 'string'],
            'email_template_reminder3'           => ['required' => false, 'default_value' => trans('texts.reminder3_body'), 'type' => 'string'],
            'email_template_reminder_endless'    => ['required' => false, 'default_value' => trans('texts.endless_body'), 'type' => 'string'],
