...
class AccountSettings extends BaseSettings
{
        private $settings = [
            ...
            'email_subject_custom1'              => ['required' => false, 'default_value' => trans('texts.custom1.subject'), 'type' => 'string'],
            'email_subject_custom2'              => ['required' => false, 'default_value' => trans('texts.custom2.subject'), 'type' => 'string'],
            'email_subject_custom3'              => ['required' => false, 'default_value' => trans('texts.custom3.subject'), 'type' => 'string'],
            'email_template_custom1'             => ['required' => false, 'default_value' => trans('texts.custom1.body'), 'type' => 'string'],
            'email_template_custom2'             => ['required' => false, 'default_value' => trans('texts.custom2.body'), 'type' => 'string'],
            'email_template_custom3'             => ['required' => false, 'default_value' => trans('texts.custom3.body'), 'type' => 'string'],
            ...
            'email_subject_reminder1'            => ['required' => false, 'default_value' => trans('texts.reminder1.subject'), 'type' => 'string'],
            'email_subject_reminder2'            => ['required' => false, 'default_value' => trans('texts.reminder2.subject'), 'type' => 'string'],
            'email_subject_reminder3'            => ['required' => false, 'default_value' => trans('texts.reminder3.subject'), 'type' => 'string'],
            'email_subject_reminder_endless'     => ['required' => false, 'default_value' => trans('texts.endless.subject'), 'type' => 'string'],
            'email_template_reminder1'           => ['required' => false, 'default_value' => trans('texts.reminder1.body'), 'type' => 'string'],
            'email_template_reminder2'           => ['required' => false, 'default_value' => trans('texts.reminder2.body'), 'type' => 'string'],
            'email_template_reminder3'           => ['required' => false, 'default_value' => trans('texts.reminder3.body'), 'type' => 'string'],
            'email_template_reminder_endless'    => ['required' => false, 'default_value' => trans('texts.endless.body'), 'type' => 'string'],
