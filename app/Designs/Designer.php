...
class Designer
{
    ...
    private $default_columns = [
        ...
        private $entity_columns = [
            'order' => [
            '$order.number'          => '<span>$order.number_label: $invoice.number</span>',
            '$order.po_number'       => '<span>$order.po_number_label: $invoice.po_number</span>',
            '$order.invoice_date'    => '<span>$order.date_label: $invoice.date</span>',
            '$order.due_date'        => '<span>$order.due_date_label: $invoice.due_date</span>',
            '$order.balance'         => '<span>$order.balance_due_label: $invoice.balance_due</span>',
            '$order.invoice_total'   => '<span>$order.total_label: $invoice.total</span>',
            '$order.partial_due'     => '<span>$order.partial_due_label: $invoice.partial_due</span>',
            '$order.custom1'         => '<span>$order1_label: $invoice.custom1</span>',
            '$order.custom2'         => '<span>$order2_label: $invoice.custom2</span>',
            '$order.custom3'         => '<span>$order3_label: $invoice.custom3</span>',
            '$order.custom4'         => '<span>$order4_label: $invoice.custom4</span>',
