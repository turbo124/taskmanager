...
export default class UserItem extends Component {
    ...
    render () {
        ...
        if (users && users.length) {
            return return users.map((user, index) => {
                ...
                const columnList = Object.keys(user).filter(key => {
                    ...
                    return <td key={key}
                        ...
                        data-label={key}><UserPresenter edit={editButton} toggleViewedEntity={this.props.toggleViewedEntity}
                ...
                return !this.props.show_list ? <tr className={selectedRow} key={user.id}>
                    <td>
