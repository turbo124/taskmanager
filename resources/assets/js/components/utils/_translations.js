...
_localizedValues.en = {
    ...
    expenses_imported_successfully: 'All expenses were imported successfully',
    expense_import_failed: 'The import process failed',
    no_expenses_found: 'No transactions could be found',
    new_expense: 'New Expense',
    invalid_contacts_error: 'Please ensure all contact fields are completed',
    empty_contacts_error: 'You must create at least one contact',
    ...
    show_transaction_fee: 'Show Transaction Fee',
    show_shipping_cost: 'Show shipping cost',
    show_gateway_fee: 'Show gateway fee',
    show_tax_rate1: 'Show first tax rate',
    ...
    change_requested: 'Successfully requested change',
    ...
    archive_message: 'Are you sure you want to archive this?',
    refresh: 'Refresh',
    ...
    quote_change_requested: 'Quote Change Requested',
    purchase_order_approved: 'Purchase Order Approved',
    purchase_order_rejected: 'Purchase Order Rejected',
    purchase_order_change_requested: 'Purchase Order Change Requested',
    ...
    clone_to_recurring_quote: 'Clone to Recurring Quote',
