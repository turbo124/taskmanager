...
export default class DeleteModal extends Component {
    ...
    render () {
        ...
        const button = this.props.is_button ? <Button color="danger" onClick={this.toggle}><i className={`fa ${icon} mr-2`}/>{text}</Button> : <DropdownItem onClick={this.toggle}><i className={`fa ${icon} mr-2`}/>{text}</DropdownItem>
