...
export default function Overview (props) {
    ...
    if (props.entity.custom_value1.length) {
        const label1 = props.model.getCustomFieldLabel('Credit', 'custom_value1')
    ...
    if (props.entity.custom_value2.length) {
        const label2 = props.model.getCustomFieldLabel('Credit', 'custom_value2')
    ...
    if (props.entity.custom_value3.length) {
        const label3 = props.model.getCustomFieldLabel('Credit', 'custom_value3')
    ...
    if (props.entity.custom_value4.length) {
        const label4 = props.model.getCustomFieldLabel('Credit', 'custom_value4')
    ...
    if (props.entity.balance > 0) {
        fields.balance_remaining = <FormatMoney customers={props.customers} amount={props.entity.balance}/>
    }
