...
export default function Overview (props) {
    ...
    if (props.entity.custom_value1.length) {
        const label1 = props.model.getCustomFieldLabel('Quote', 'custom_value1')
    ...
    if (props.entity.custom_value2.length) {
        const label2 = props.model.getCustomFieldLabel('Quote', 'custom_value2')
    ...
    if (props.entity.custom_value3.length) {
        const label3 = props.model.getCustomFieldLabel('Quote', 'custom_value3')
    ...
    if (props.entity.custom_value4.length) {
        const label4 = props.model.getCustomFieldLabel('Quote', 'custom_value4')
