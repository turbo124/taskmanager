...
// task status
        ...
        Route::post('invoice/restore/{id}', 'InvoiceController@restore')->middleware(
            'role:null,invoicecontroller.index'
        );;
        ...
        Route::put('invoice/{invoice_id}', 'InvoiceController@update')->middleware(
            'role:null,invoicecontroller.update'
        );
        Route::get(
        ...
        )->middleware('role:null,invoicecontroller.bulk');
        Route::put(
        ...
        Route::get('recurring-quote', 'RecurringQuoteController@index')->middleware(
            'role:null,invoicecontroller.store'
        );
        Route::post('recurring-quote', 'RecurringQuoteController@store')->middleware(
            'role:null,invoicecontroller.store'
        );
        Route::post(
        ...
        )->middleware('role:null,invoicecontroller.show');
...
// customers
        ...
        )->middleware('role:null,customercontroller.dashboard');
        Route::get('customers/{customer_id}', 'CustomerController@show')->middleware(
            'role:null,customercontroller.show'
        );
        Route::put(
            'customers/{customer_id}',
            'CustomerController@update'
        )->middleware('role:null,customercontroller.update');
        ...
        )->middleware('role:null,customercontroller.destroy');
        Route::delete(
            'customers/{customer_id}',
...
// tasks
        ...
        )->middleware('role:null,taskcontroller.gettasksforproject');
        Route::put(
            'tasks/complete/{task}',
            'TaskController@markAsCompleted'
        )->middleware('role:null,taskcontroller.markascompleted');
        ...
        )->middleware('role:null,taskcontroller.getsubtasks');
        Route::get(
            'tasks/products/{task_id}',
            'TaskController@getProducts'
        )->middleware('role:null,taskcontroller.getproducts');
        ...
        Route::get('tasks/convertToDeal/{task_id}', 'TaskController@convertToDeal')->middleware(
            'role:null,view-invoice'
        );
        Route::put('tasks/timer/{task_id}', 'TaskController@updateTimer')->middleware(
